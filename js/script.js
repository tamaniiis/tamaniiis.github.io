...
---------------------------------------------*/
	...
	$('.conteneur').bind('animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd', function(e) { /*$(this).remove();*/
		/*$(this).fadeOut( "slow" );*/
		/*document.getElementsByClassName("conteneur").style.pointerEvents = "none";*/
		document.getElementById("introan").fadeOut( "slow" );
...
$(document).ready(function(){
	setTimeout( function(){
        ...
        $(".typewrite span").typed({
            strings: ["dizaini ", "fotogrāfijas " , "portfolio"],
            typeSpeed: 100,
            backDelay: 500,
            loop: false,
